...
db.exec(`
  ...
  CREATE TABLE IF NOT EXISTS shifts (
    ...
    location_id TEXT REFERENCES locations(id) ON DELETE SET NULL,
    date TEXT NOT NULL, start_time TEXT NOT NULL DEFAULT '09:00',
    end_time TEXT NOT NULL DEFAULT '17:00', notes TEXT, note_color TEXT,
  ...
  INSERT OR IGNORE INTO settings(key,value) VALUES
    ('allow_signup','true'),('app_name','ForgeShift'),
    ('ical_enabled','true'),('ical_cal_name','ForgeShift');
`);
